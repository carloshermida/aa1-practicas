...
module modelComparison
    ...
    export calculateMinMaxNormalizationParameters, calculateZeroMeanNormalizationParameters
    ...
    export normalizeMinMax!, normalizeMinMax
    ...
    export normalizeZeroMean!, normalizeZeroMean
    ...
    export buildClassANN, trainClassANN
